            ...
            <div className="container">
                <div className="row justify-content-center">             
                    ...
                    <div className="col-7 col-sm-5">
                        ...
                        <i className="fa fa-phone fa-lg"></i>: +92 334 3340629<br />
                        <i className="fa fa-fax fa-lg"></i>: (fax number to be added)<br />
                        <i className="fa fa-envelope fa-lg"></i>: <a href="mailto:mustafamirza45@gmail.com">
                            Foodville</a>
                        </address>
                    </div>
                ...
                <div className="row justify-content-end">
                    <div className="col-12 col-sm-4">
                            <div className="text-center">
                                ...
                                <a className="btn btn-social-icon" href="mailto:mustafamirza45@gmail.com"><i className="fa fa-envelope-o"></i></a>
                            </div>
                    </div>
                </div>
